...
var t_area = (larg.value*com.value)*1.2
...
if(t_total<orca.value){
    document.querySelector('#resp').innerHTML='Valor da compra é compativel com o orçamento'
}else{
    document.querySelector('#resp').innerHTML='Valor da compra não é compativel'
}
